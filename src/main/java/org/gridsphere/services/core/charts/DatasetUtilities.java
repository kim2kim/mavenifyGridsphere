...
public class DatasetUtilities {
    ...
    public static org.jfree.data.general.DefaultPieDataset readDefaultPieDataset(File file) throws IOException, MarshalException, ValidationException {
        FileReader reader = new FileReader(file);
        DefaultPieDataset dataset = (DefaultPieDataset) DefaultPieDataset.unmarshal(reader);
        reader.close();
        org.jfree.data.general.DefaultPieDataset outDataset = new org.jfree.data.general.DefaultPieDataset();
    ...
    public static void writeDefaultPieDataset(File file, org.jfree.data.general.DefaultPieDataset inDataset) throws IOException, MarshalException, ValidationException {
    ...
    public static org.jfree.data.category.DefaultCategoryDataset readDefaultCategoryDataset(File file) throws IOException, MarshalException, ValidationException {
        FileReader reader = new FileReader(file);
        DefaultCategoryDataset dataset = (DefaultCategoryDataset) DefaultCategoryDataset.unmarshal(reader);
        reader.close();
        org.jfree.data.category.DefaultCategoryDataset outDataset = new org.jfree.data.category.DefaultCategoryDataset();
    ...
    public static void writeDefaultCategoryDataset(File file, org.jfree.data.category.DefaultCategoryDataset inDataset) throws IOException, MarshalException, ValidationException {
    ...
    public static org.jfree.data.xy.XYSeriesCollection readXYSeriesCollection(File file) throws IOException, ValidationException, MarshalException {
        FileReader reader = new FileReader(file);
        XYSeriesCollection dataset = (XYSeriesCollection) XYSeriesCollection.unmarshal(reader);
        reader.close();
        org.jfree.data.xy.XYSeriesCollection outDataset = new org.jfree.data.xy.XYSeriesCollection();
        ...
        while (series.hasMoreElements()) {
            ...
            org.jfree.data.xy.XYSeries outSeries = new org.jfree.data.xy.XYSeries(serie.getName());
    ...
    public static void writeXYSeriesCollection(File file, org.jfree.data.xy.XYSeriesCollection inDataset) throws IOException, MarshalException, ValidationException {
        ...
        for (int i = 0; i < inDataset.getSeriesCount(); ++i) {
            String name = inDataset.getSeries(i).getDescription();        	
            ...
            for (int j = 0; j < inDataset.getItemCount(i); ++j) {
                ...
                item.setXValue(inDataset.getXValue(i, j));
                if (Double.valueOf(inDataset.getYValue(i, j)) != null)
                    item.setYValue(inDataset.getYValue(i, j));
    ...
    public static org.jfree.data.time.TimeSeriesCollection readTimeSeriesCollection(File file) throws IOException, MarshalException, ValidationException, org.jfree.data.general.SeriesException {
        FileReader reader = new FileReader(file);
        ...
        while (series.hasMoreElements()) {
            ...
            if (serie.hasHistoryCount())
                outSeries.setMaximumItemAge(Integer.valueOf(serie.getHistoryCount()).longValue());
            if (serie.getDescription() != null)
                outSeries.setDescription(serie.getDescription());
    ...
    public static void writeTimeSeriesCollection(File file, org.jfree.data.time.TimeSeriesCollection inDataset) throws IOException, MarshalException, ValidationException {
        ...
        for (int i = 0; i < inDataset.getSeriesCount(); ++i) {
            ...
            String name = serie.getDescription();
            ...
            long historyCount = serie.getMaximumItemAge();
            if (description != null)
                series.setDescription(description);
            ...
            if (maximumItemCount != Integer.MAX_VALUE)
                series.setMaximumItemCount(maximumItemCount);
            if (historyCount != 0)
                series.setHistoryCount(Long.valueOf(historyCount).intValue());
            for (int j = 0; j < inDataset.getItemCount(i); ++j) {
    ...
    public static void writeTaskSeriesCollection(File file, org.jfree.data.gantt.TaskSeriesCollection inDataset) throws IOException, MarshalException, ValidationException{
        ...
        for(int i=0; i<inDataset.getRowCount();++i){
            String serieName=inDataset.getSeries(i).getDescription();
