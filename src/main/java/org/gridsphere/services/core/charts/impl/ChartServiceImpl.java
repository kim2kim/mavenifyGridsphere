...
import org.gridsphere.services.core.charts.BackgroundPaint;
import org.gridsphere.services.core.charts.Category;
import org.gridsphere.services.core.charts.ChartDescriptor;
import org.gridsphere.services.core.charts.ChartInfo;
import org.gridsphere.services.core.charts.ChartService;
import org.gridsphere.services.core.charts.Color;
import org.gridsphere.services.core.charts.Dataset;
import org.gridsphere.services.core.charts.DatasetUtilities;
import org.gridsphere.services.core.charts.FileInfo;
import org.gridsphere.services.core.charts.Font;
import org.gridsphere.services.core.charts.FontType;
import org.gridsphere.services.core.charts.GradientPoint;
import org.gridsphere.services.core.charts.Image;
import org.gridsphere.services.core.charts.NoDataMessage;
import org.gridsphere.services.core.charts.Paint;
import org.gridsphere.services.core.charts.PaintType;
import org.gridsphere.services.core.charts.Pie;
import org.gridsphere.services.core.charts.Plot;
import org.gridsphere.services.core.charts.Settings;
...
public class ChartServiceImpl implements ChartService, PortletServiceProvider {
    ...
    public ChartDescriptor createPieChart(FileLocationID fileLocationID, org.jfree.data.general.DefaultPieDataset dataset) throws IOException, Exception {
        return createChart(fileLocationID, dataset, "Pie");
    }

    public ChartDescriptor createPie3DChart(FileLocationID fileLocationID, org.jfree.data.general.DefaultPieDataset dataset) throws IOException, Exception {
        return createChart(fileLocationID, dataset, "Pie3D");
    }

    public ChartDescriptor createBarChart(FileLocationID fileLocationID, org.jfree.data.category.DefaultCategoryDataset dataset) throws IOException, Exception {
        return createChart(fileLocationID, dataset, "Bar");
    }

    public ChartDescriptor createBar3DChart(FileLocationID fileLocationID, org.jfree.data.category.DefaultCategoryDataset dataset) throws IOException, Exception {
        return createChart(fileLocationID, dataset, "Bar3D");
    }

    public ChartDescriptor createStackedBarChart(FileLocationID fileLocationID, org.jfree.data.category.DefaultCategoryDataset dataset) throws IOException, Exception {
        return createChart(fileLocationID, dataset, "StackedBar");
    }

    public ChartDescriptor createStackedBar3DChart(FileLocationID fileLocationID, org.jfree.data.category.DefaultCategoryDataset dataset) throws IOException, Exception {
        return createChart(fileLocationID, dataset, "StackedBar3D");
    }

    public ChartDescriptor createAreaChart(FileLocationID fileLocationID, org.jfree.data.category.DefaultCategoryDataset dataset) throws IOException, Exception {
        return createChart(fileLocationID, dataset, "Area");
    }

    public ChartDescriptor createStackedAreaChart(FileLocationID fileLocationID, org.jfree.data.category.DefaultCategoryDataset dataset) throws IOException, Exception {
        return createChart(fileLocationID, dataset, "StackedArea");
    }

    public ChartDescriptor createLineChart(FileLocationID fileLocationID, org.jfree.data.category.DefaultCategoryDataset dataset) throws IOException, Exception {
    ...
    public ChartDescriptor createBarXYChart(FileLocationID fileLocationID, org.jfree.data.xy.XYSeriesCollection dataset) throws IOException, Exception {
        return createChart(fileLocationID, dataset, "BarXY");
    }

    public ChartDescriptor createAreaXYChart(FileLocationID fileLocationID, org.jfree.data.xy.XYSeriesCollection dataset) throws IOException, Exception {
        return createChart(fileLocationID, dataset, "AreaXY");
    }

    public ChartDescriptor createLineXYChart(FileLocationID fileLocationID, org.jfree.data.xy.XYSeriesCollection dataset) throws IOException, Exception {
        return createChart(fileLocationID, dataset, "LineXY");
    }

    public ChartDescriptor createStepAreaXYChart(FileLocationID fileLocationID, org.jfree.data.xy.XYSeriesCollection dataset) throws IOException, Exception {
    ...
    private ChartDescriptor createChart(FileLocationID fileLocationID, org.jfree.data.general.Dataset dataset, String type) throws IOException, Exception {
        String userID = fileLocationID.getUserID();
        String appName = fileLocationID.getCategory();
        String resource = fileLocationID.getFilePath();
    ...
    public void setChartDataset(FileLocationID fileLocationID, org.jfree.data.general.Dataset inDataset, long datasetTimeStamp) throws IOException, Exception {
        String userID = fileLocationID.getUserID();
        String appName = fileLocationID.getCategory();
        String resource = fileLocationID.getFilePath();
        ChartDescriptor chartDescriptor = readChartDescriptor(userID, appName, resource);
    ...
    public void setChartDataset(FileLocationID fileLocationID, org.jfree.data.general.Dataset inDataset) throws IOException, Exception {
        String userID = fileLocationID.getUserID();
        String appName = fileLocationID.getCategory();
        String resource = fileLocationID.getFilePath();
        ChartDescriptor chartDescriptor = readChartDescriptor(userID, appName, resource);
...
//            File imageFile = getChartImageFile(userID, appName, resource);
        ...
        org.jfree.data.general.Dataset dataset = readDataset(userID, chartDescriptor.getFileInfo().getDataset().getAppName(), resource, chartDescriptor.getFileInfo().getDataset().getType());
        ...
        try {
            if (chartInfo.getType().equals("Pie")) {
                ...
                if (dataset instanceof org.jfree.data.xy.XYSeriesCollection)
        ...
        try {
            for (int i = 0; i < plotInfo.getSeriesPaintCount(); ++i) {
                if (chartDescriptor.getFileInfo().getDataset().getType().equals("org.jfree.data.general.DefaultPieDataset"))
                    ((org.jfree.chart.plot.PiePlot) chart.getPlot()).setSectionPaint(i, createPaint(plotInfo.getSeriesPaint(i)));
                else if (chartDescriptor.getFileInfo().getDataset().getType().equals("org.jfree.data.category.DefaultCategoryDataset") || chartDescriptor.getFileInfo().getDataset().getType().equals("org.jfree.data.gantt.TaskSeriesCollection"))
                    chart.getCategoryPlot().getRenderer().setSeriesPaint(i, createPaint(plotInfo.getSeriesPaint(i)));
                else if (chartDescriptor.getFileInfo().getDataset().getType().equals("org.jfree.data.xy.XYSeriesCollection") || chartDescriptor.getFileInfo().getDataset().getType().equals("org.jfree.data.time.TimeSeriesCollection"))
        ...
        if (plotInfo.getSettings().getPie() != null)
            try {
                ((org.jfree.chart.plot.PiePlot) plot).setLabelGenerator(new org.jfree.chart.labels.StandardPieSectionLabelGenerator(plotInfo.getSettings().getPie().getLabelGenerator()));
            } catch (ClassCastException e) {
            }
    ...
    private ChartDescriptor createChartDescriptor(String userID, String appName, String resource, String type, org.jfree.data.general.Dataset inDataset) throws IOException, Exception {
        writeDataset(userID, appName, resource, inDataset);
    ...
    private void writeDataset(String userID, String appName, String resource, org.jfree.data.general.Dataset inDataset) throws IOException, Exception {
        File file = secureDirectoryService.getFile(secureDirectoryService.createFileLocationID(userID, appName, resource + ".xml"));
        try {
            if (inDataset.getClass().getName().equals("org.jfree.data.general.DefaultPieDataset"))
                DatasetUtilities.writeDefaultPieDataset(file, (org.jfree.data.general.DefaultPieDataset) inDataset);
            else if (inDataset.getClass().getName().equals("org.jfree.data.category.DefaultCategoryDataset"))
                DatasetUtilities.writeDefaultCategoryDataset(file, (org.jfree.data.category.DefaultCategoryDataset) inDataset);
            ...
            else if (inDataset.getClass().getName().equals("org.jfree.data.xy.XYSeriesCollection"))
                DatasetUtilities.writeXYSeriesCollection(file, (org.jfree.data.xy.XYSeriesCollection) inDataset);
        } catch (MarshalException e) {
            file.delete();
    ...
    private org.jfree.data.general.Dataset readDataset(String userID, String appName, String resource, String type) throws IOException, MarshalException, ValidationException, Exception {
        File file = secureDirectoryService.getFile(secureDirectoryService.createFileLocationID(userID, appName, resource + ".xml"));
        org.jfree.data.general.Dataset dataset = null;
        if (type.equals("org.jfree.data.general.DefaultPieDataset"))
            dataset = DatasetUtilities.readDefaultPieDataset(file);
        else if (type.equals("org.jfree.data.category.DefaultCategoryDataset"))
        ...
        else if (type.equals("org.jfree.data.xy.XYSeriesCollection"))
